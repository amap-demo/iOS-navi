//
//  EmulatorNaviViewController.swift
//  officialDemoNavi
//
...
class EmulatorNaviViewController: UIViewController, AMapNaviDriveManagerDelegate, AMapNaviDriveViewDelegate, MoreMenuViewDelegate {
